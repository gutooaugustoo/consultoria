...
$caminho = CAM_VIEW."modelo/";
$atualizar = CAM_VIEW."modelo/lista.php";
$ondeAtualizar = "tr";	
...
if( $_REQUEST["tr"] == "1" ){
	...
	$arrayRetorno["updateTr"] = $Modelo->tabela_html(" WHERE id = $id", $caminho, $atualizar, $ondeAtualizar, $campos, $ordem);
...
$corpoTabela = $Modelo->tabela_html($where, $caminho, $atualizar, $ondeAtualizar, $campos);
?>
