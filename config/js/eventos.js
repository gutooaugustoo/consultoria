...
function eventFocoForm() {
	...
	$('body').off('focusin, focusout', 'form input, form select, form textarea').on('focusin', 'form input, form select, form textarea', focoIn).on('focusout', 'form input, form select, form textarea', focoOut);
