...
class PHPMailer {
   ...
   * is in a different directory than the PHP require_once path.
   * @var string
   */
  public $PluginDir         = '';
 ...
 */
  ...
  */
  function SetLanguage($langcode = 'en', $lang_path = 'language/') {
    ...
    if ($langcode != 'en') { //There is no English translation file
      $l = @require_once $lang_path.'phpmailer.lang-'.$langcode.'.php';
    }
  ...
  */
  ...
  /**
   * Adds an embedded attachment.  This can require_once images, sounds, and
