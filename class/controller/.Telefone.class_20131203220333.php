	...
	function tabelaTelefone_html($where = "", $caminho = "", $atualizar = "", $ondeAtualizar = "", $campos = array("*"), $apenasLinha = false){
		...
		if( $array ){
			...
			foreach($array as $iten){
				...
				$Pessoa = new Pessoa( $this -> get_pessoa_idTelefone() );
				$colunas[] = $Pessoa -> get_idPessoa();
				$Empresa = new Empresa( $this -> get_empresa_idTelefone() );
				$colunas[] = $Empresa -> get_idEmpresa();
				$Descricaotelefone = new Descricaotelefone( $this -> get_descricaoTelefone_idTelefone() );
				$colunas[] = $Descricaotelefone -> get_idDescricaotelefone();
