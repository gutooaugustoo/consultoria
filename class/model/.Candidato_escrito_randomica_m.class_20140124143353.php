...
class Candidato_escrito_randomica_m extends Database { 
    ...
    if( $array ){
      			$this -> idCandidato_escrito_randomica = $array[0]['id'];			$this -> escrito_idCandidato_escrito_randomica = $array[0]['escrito_id'];			$this -> servico_candidato_idCandidato_escrito_randomica = $array[0]['servico_candidato_id'];			$this -> servico_avaliador_idCandidato_escrito_randomica = $array[0]['servico_avaliador_id'];			$this -> finalizadoCandidato_escrito_randomica = $array[0]['finalizado'];			
		}
