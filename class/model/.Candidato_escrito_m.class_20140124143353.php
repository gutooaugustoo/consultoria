...
class Candidato_escrito_m extends Database { 
    ...
    if( $array ){
      			$this -> idCandidato_escrito = $array[0]['id'];			$this -> escrito_idCandidato_escrito = $array[0]['escrito_id'];			$this -> servico_candidato_idCandidato_escrito = $array[0]['servico_candidato_id'];			$this -> servico_avaliador_idCandidato_escrito = $array[0]['servico_avaliador_id'];			$this -> finalizadoCandidato_escrito = $array[0]['finalizado'];			
		}
